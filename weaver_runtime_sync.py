...
def sync_completions(connection, payload: dict[str, Any]) -> dict[str, Any]:
    ...
    for completion in completions:
        ...
        insert_graphics_completion(connection, {
            ...
            "asset_file_id": normalize_text(completion.get("assetFileId") or completion.get("driveFileId") or completion.get("fileId")),
            "drive_file_id": normalize_text(completion.get("driveFileId") or completion.get("assetFileId") or completion.get("fileId")),
            "pig_project_id": normalize_text(completion.get("pigProjectId")),
            "editable_project_file_id": normalize_text(completion.get("editableProjectFileId") or completion.get("projectFileId")),
            "editable_project_url": normalize_text(completion.get("editableProjectUrl")),
            "editable_project_kind": normalize_text(completion.get("editableProjectKind")),
            "editable_project_schema_version": normalize_text(completion.get("editableProjectSchemaVersion")),
        ...
        update_graphics_handoff(connection, ledger_request_id, {
            ...
            "assetFileId": completion.get("assetFileId") or completion.get("driveFileId") or completion.get("fileId"),
            "driveFileId": completion.get("driveFileId") or completion.get("assetFileId") or completion.get("fileId"),
            ...
            "editableProjectKind": completion.get("editableProjectKind"),
            "editableProjectSchemaVersion": completion.get("editableProjectSchemaVersion"),
...
def upsert_video_curation_gate(connection, payload: dict[str, Any]) -> dict[str, Any]:
    ...
    record = {
        **existing,
        ...
        "prioritySetId": priority_set_id,
        "sourceFileId": source_file_id,
        "sourceReviewFileId": normalize_text(source.get("sourceReviewFileId")) or normalize_text(existing.get("sourceReviewFileId")),
        "sourceFileName": normalize_text(source.get("sourceFileName")),
        "sourceVideoUrl": normalize_text(source.get("sourceVideoUrl")),
        "author": normalize_text(source.get("author")),
        "poemTitle": normalize_text(source.get("poemTitle")),
